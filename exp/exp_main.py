...
from models import MCTEM, DLinear, NLinear
...
class Exp_Main(Exp_Basic):
    def __init__(self, args):
        ...
        self.print_rmse = args.print_rmse
        self.print_mae = args.print_mae
        self.print_mse = args.print_mse
